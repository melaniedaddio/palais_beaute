...
urlpatterns = [
    ...
    path('api/cartes-cadeaux/renseigner/', views.api_renseigner_carte_cadeau, name='api_renseigner_carte_cadeau'),
    path('api/forfaits/renseigner/', views.api_renseigner_forfait, name='api_renseigner_forfait'),
